...
/**
 * Representa un punto en el plano cartesiano (una pareja ordenada de dos numeros).
 * @since 1.0
 */ 
public class Punto {
     ...
     * @param p1 punto que con p2 y <code>this</code> se determina si estan alineados
     * @param p2 punto que con p1 y <code>this</code> se determina si estan alineados
     * @return <code>true</code> si los puntos estan alineados
     * @since 1.0
     */
