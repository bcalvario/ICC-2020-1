...
/**
 * Clase para crear imagenes basicas en formato SVG.
 */
public class SVG {
     ...
     * (c, d) son los dos puntos que conforman la linea dada.
     * @param linea contiene los dos puntos entre los cuales se trazara una linea
     */
    public void agregarLinea(Linea linea) {
        String s = "<line x1 = \"" + linea.getP1().getX() + "\" y1 = \"" + linea.getP1().getY() +
        "\" x2 = \"" + linea.getP2().getX() + "\" y2 = \"" + linea.getP2().getY() + 
        "\" style=\"stroke: black; stroke-width: 1; fill: none\" />";
        concatenar (s);
    }

    /**
     * Agrega tres elementos de tipo &lt;line&gt; a esta imagen, tales que representan un triangulo.
     * @param triangulo contiene los tres puntos entre los cuales se trazaran tres lineas.
     */
     ...
     * centro del circulo dado y ra es el radio.
     * @param circulo indica el centro del circulo y su radio
    ...
    /**
     * Agrega la cadena dada con la indentacion especificada por la variable nivel, seguida de
     * un salto de linea.
